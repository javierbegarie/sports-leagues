...
/**
 * Local mock data — kept around for offline development and tests.
 * Not used by SportLeaguesApi anymore (it now hits TheSportsDB), but
 * handy for swapping in via a fixture or interceptor.
 */
